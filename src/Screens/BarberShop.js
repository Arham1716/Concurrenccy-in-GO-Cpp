...
import cpuGraphCPP from '../assets/cpp_graphs/FIFOBarbershop_CPU.png';
import memoryGraphCPP from '../assets/cpp_graphs/FIFOBarberShop_Memory.png';
import cpuGraphGO from '../assets/go_graphs/FIFOBarberShop_CPU.jpg';
import memoryGraphGO from '../assets/go_graphs/FIFO BarberShop_Memory.png';
  ...
  const runSimulation = async () => {
    const apiUrl =
      selectedLanguage === "cpp"
        ? "http://localhost:5000/FIFOBarberShop"
        : "http://localhost:5001/FIFOBarberShop";
    ...
    <>
      <div className="container d-flex flex-column align-items-center py-5">
        ...
        <div className="problem-container p-4 text-center">
          <h3 className="problem-title">Problem Title: Sleeping Barber</h3>

          {/* Problem Description */}
          <div className="problem-description text-start">
            <p>
              The <strong>Sleeping Barber Problem</strong> is a classic synchronization
              problem that illustrates the complexities of process synchronization and
              resource allocation. A barbershop has one barber, one barber chair, and
              several waiting chairs for customers. If there are no customers, the
              barber sleeps in the chair. When a customer arrives, they must wake
              the barber. If another customer arrives while the barber is cutting
              someone's hair, they either wait or leave if all chairs are occupied.
            </p>
            <p>
              The challenge is to coordinate the barber and customers to ensure proper
              service without race conditions or deadlocks, while maintaining fairness

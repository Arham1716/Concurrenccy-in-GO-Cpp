...
import cpuGraphCPP from '../assets/cpp_graphs/RiverCrossing_CPU.png';
import memoryGraphCPP from '../assets/cpp_graphs/RiverCrossing_Memory.png';
import cpuGraphGO from '../assets/go_graphs/RiverCrossing_CPU.jpg';
import memoryGraphGO from '../assets/go_graphs/RiverCrossing_Memory.png';
  ...
  const runSimulation = async () => {
    const apiUrl =
      selectedLanguage === "cpp"
        ? "http://localhost:5000/RiverCrossing"
        : "http://localhost:5001/RiverCrossing";
    ...
    <>
      <div className="container d-flex flex-column align-items-center py-5">
        ...
        <div className="problem-container p-4 text-center">
          <h3 className="problem-title">Problem Title: River Crossing</h3>

          {/* Problem Description */}
          <div className="problem-description text-start">
            <p>
              The <strong>River Crossing Problem</strong> involves managing the safe
              crossing of a river by different types of travelers. The challenge is
              to ensure that all travelers cross safely while following specific
              rules and constraints, such as the boat's capacity and valid
              combinations of passengers.
            </p>
            <p>
              The solution must prevent unsafe combinations, manage the boat's
              capacity, and ensure efficient crossings while avoiding deadlocks
              and maintaining proper synchronization between all parties involved.
            </p>
          </div>
